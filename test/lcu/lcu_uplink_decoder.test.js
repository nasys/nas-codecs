...
describe("Commands", () => {
    ...
    test("custom_dali_request response from DS", () => {
        testOnePacket({
            ...
            expected: {"data":{"packet_type":{"value":"custom_dali_request"},"queries":[{"dali_address_short":{"value":"single 36","raw":72},"dali_query":{"value":161},"dali_answer":{"value":254}},{"dali_address_short":{"value":"single 36","raw":72},"dali_query":{"value":162},"dali_answer":{"value":168}},{"dali_address_short":{"value":"single 36","raw":72},"dali_query":{"value":163},"dali_answer":{"value":254}},{"dali_address_short":{"value":"single 36","raw":72},"dali_query":{"value":164},"dali_answer":{"value":254}},{"dali_address_short":{"value":"single 36","raw":72},"dali_query":{"value":165},"dali_answer":{"value":7}}]},"errors":[],"warnings":[]}
        });
    });
    ...
    test("driver_memory_write response", () => {
        testOnePacket({
            ...
            expected: {"data":{"packet_type":{"value":"driver_memory_write"},"dali_address_short":{"value":"single 2","raw":4},"memory_bank":{"value":0},"memory_address":{"value":3},"read_size":{"value":6,"unit":"bytes"},"memory_value":{"value":"07EDFACE82E5"}},"errors":[],"warnings":[]}
        });
    });
