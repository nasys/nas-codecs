...
describe('CM30xx tests', () => {
  ...
  test('usage DS', () => {
    testPacket({
      ...
      expected: {
        data: {
          _app_connected_within_a_day: true, _meter_medium: 'gas', _meter_multiplier: 0.01, _meter_unit: 'm3', _packet_type: 'usage_packet', active_alerts: [], meter_accumulated_volume__m3: '000000.84', meter_actuality_duration__minutes: 1, meter_actuality_duration_formatted: '1 minutes', meter_status: 'connected',
        },
      },
    });
  });
  ...
  test('boot packet', () => {
    testPacket({
      ...
      expected: {
        data: {
          _packet_type: 'boot_packet', configuration_restored: true, device_firmware_version: '2.3.18', device_serial: '5016002B', device_uptime_accumulated__days: 183.63, hardware_configuration: 'invalid_hardware_config', packet_reason: 'from_shutdown', wakeup_reason_mcu: ['nfc_wakeup'],
        },
  ...
  test('shutdown packet DS', () => {
    testPacket({
      ...
      expected: {
        data: {
          _app_connected_within_a_day: true, _meter_medium: 'gas', _meter_multiplier: 10, _meter_unit: 'ft3', _packet_type: 'shutdown_packet', _shutdown_reason: 'app_shutdown', active_alerts: ['backflow_pending', 'no_usage'], meter_accumulated_volume__ft3: '890074230', meter_actuality_duration__minutes: 105, meter_actuality_duration_formatted: '1.75 hours', meter_status: 'connected',
        },
      },
    });
  });
