...
describe("UM3xxx tests", () => {
    ...
    test("usage_spec_ssi", () => {
        testPacket({
            ...
            expected: {"_app_connected_within_a_day":true,"_packet_type":"usage_packet","_raw_payload":"028200100105C74B873F9A99B941","active_alerts":["pulse_2_trigger_alert"],"meter_actuality_duration__minutes":0,"meter_actuality_duration_formatted":"0 minutes","ssi_channel_1":1.057,"ssi_channel_2":23.2,"ssi_sensor":"pressure_30bar_temperature"},
        });
    });
    ...
    test("general_config_spec", () => {
        testPacket({
            ...
            expected: {"_packet_type":"general_configuration_packet","_raw_payload":"123117024F0A0001404B4C00CEFFFFFF785634120A00","pulse_1_accumulated_absolute":50000000,"pulse_1_accumulated_offset":-500,"pulse_1_input_mode_and_unit":"L_water","pulse_1_multiplier_denominator":1,"pulse_1_multiplier_numerator":10,"pulse_1_serial":"12345678","pulse_2_input_mode_and_unit":"triggers_10_sec","radio_lorawan_profile":"lorawan_1_h_dynamic"},
        });
    });
    ...
    test("general_config_short", () => {
        testPacket({
            ...
            expected: {"_packet_type":"general_configuration_packet","_raw_payload":"1233170209000900","pulse_1_input_mode_and_unit":"triggers_1_sec","pulse_2_input_mode_and_unit":"triggers_1_sec","radio_lorawan_profile":"lorawan_1_h_dynamic","radio_wmbus_profile":"wmbus_driveby"},
        });
    });
    ...
    test("boot_packet", () => {
        testPacket({
            ...
            expected: {"_packet_type":"boot_packet","_raw_payload":"0027001650020312809006371100","configuration_restored":true,"device_firmware_version":"2.3.18","device_serial":"50160027","device_uptime_accumulated__days":183.63,"hardware_configuration":"pulse_lbus","packet_reason":"from_shutdown","wakeup_reason_mcu":["nfc_wakeup"]},
        });
    });
