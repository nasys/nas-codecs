import { decodeRaw, decodeUnixEpoch } from '../src/ul20xx_decoder';
...
describe('Config packts', () => {
  test('ldr_config_packet from DS', () => {
    testPacket({
      ...
      expected: {
        data: {
          packet_type: { value: 'ldr_config_packet' }, switch_threshold_high: { value: 160, raw: 160 }, switch_threshold_low: { value: 48, raw: 48 }, switch_trigger_alert_enabled: { value: true },
        },
        errors: [],
        warnings: [],
      },
  ...
  test('dig_config_packet from DS', () => {
    testPacket({
      ...
      expected: {
        data: {
          packet_type: { value: 'dig_config_packet' }, switch_time: { value: 300, raw: 300, unit: 's' }, switch_transition: { value: 'enabled', raw: true }, switch_trigger_alert_enabled: { value: false }, dali_address_short: { value: 'broadcast', raw: 254 }, dimming_level: { value: 50, unit: '%' },
        },
        errors: [],
        warnings: [],
      },
  ...
  test('meta_pos_config packet extra', () => {
    testPacket({
      ...
      expected: {
        data: {
          packet_type: { value: 'location_config_packet' }, position_latitude: { value: 59.437022, unit: '°' }, position_longitude: { value: 24.753536, unit: '°' }, address: { value: 'Ööbiku Str. 2-16' },
        },
        errors: [],
        warnings: [],
      },
  ...
  test('multicast_config_packet from DS', () => {
    testPacket({
      ...
      expected: {
        data: {
          packet_type: { value: 'multicast_config_packet' }, multicast_device: { value: 1 }, device_address: { value: '11223344' }, network_security_key: { value: '82840C7056429B143D21974557F93A53' }, application_security_key: { value: '82840C70C08494B931FE2FA6F8835C6A' },
        },
        errors: [],
        warnings: [],
      },
