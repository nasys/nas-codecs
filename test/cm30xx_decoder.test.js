import {decodeRaw, volumeFormatUnit, meterMultiplierConvert} from '../src/cm30xx_decoder.js';
...
describe("CM30xx tests", () => {
    ...
    test("usage DS", () => {
        testPacket({
            decoderFn: decodeRaw,
            fport: 25,
            data: '0411008C038f020500752B03b37f1200245f519454000000',
            expected: {"_app_connected_within_a_day":true,"_battery_voltage__V":2.77,"_internal_temperature_max__C":18,"_internal_temperature_min__C":18,"_meter_medium":"warm_water","_meter_multiplier":0.01,"_meter_unit":"m3","_packet_type":"usage_packet","_radio_downlink_snr__dB":10,"_radio_uplink_power__dBm":10,"_raw_payload":"0411008C038F020500752B03B37F1200245F519454000000","active_alerts":["backflow_pending","temperature_pending"],"battery_remaining__years":14.9,"internal_temperature__C":18,"meter_accumulated_volume__m3":"003283.35","meter_actuality_duration__minutes":3,"meter_actuality_duration_formatted":"3 minutes","meter_readout_date":"2019-12-21","meter_serial":"00549451","meter_status":"connected","radio_downlink_rssi__dBm":-36},
        });
    });
    ...
    test("usage DS", () => {
        testPacket({
            ...
            expected: {"_app_connected_within_a_day":true,"_meter_medium":"gas","_meter_multiplier":0.01,"_meter_unit":"m3","_packet_type":"usage_packet","_raw_payload":"04000014015400000001","active_alerts":[],"meter_accumulated_volume__m3":"000000.84","meter_actuality_duration__minutes":1,"meter_actuality_duration_formatted":"1 minutes","meter_status":"connected"},
        });
    });
    ...
    test("location_conf DS", () => {
        testPacket({
            ...
            expected: {"_packet_type":"location_configuration_packet","_raw_payload":"211FAC5E6D230017C10EF412C396C3B662696B75205374722E20322D31361032365630303030303030303337313734053132414236","address":"Ööbiku Str. 2-16","gps_position_latitude__deg":59.437022,"gps_position_longitude__deg":24.753536,"id_customer":"26V0000000037174","id_location":"12AB6","time_zone__h":-3},
        });
    });
    ...
    test("boot packet", () => {
        testPacket({
            ...
            expected: {"_error":["invalid_hardware_config"],"_packet_type":"boot_packet","_raw_payload":"002B0016500203128090FF0000371100","configuration_restored":true,"device_firmware_version":"2.3.18","device_serial":"5016002B","device_uptime_accumulated__days":183.63,"hardware_configuration":"invalid_hardware_config","packet_reason":"from_shutdown","wakeup_reason_mcu":["nfc_wakeup"]},
        });
    });
    ...
    test("shutdown packet DS", () => {
        testPacket({
            decoderFn: decodeRaw,
            fport: 99,
            data: '01 33 04C10057433F254E05752B036BD1164A337C44983938',
            expected: {"_app_connected_within_a_day":true,"_meter_medium":"gas","_meter_multiplier":10,"_meter_unit":"ft3","_packet_type":"shutdown_packet","_raw_payload":"013304C10057433F254E05752B036BD1164A337C44983938","_shutdown_reason":"app_shutdown","active_alerts":["backflow_pending","no_usage"],"meter_accumulated_volume__ft3":"890074230","meter_actuality_duration__minutes":105,"meter_actuality_duration_formatted":"1.75 hours","meter_status":"connected"},
        });
    });
    ...
    test("faulty downlink packet", () => {
        testPacket({
            ...
            fport: 99,
            data: '13 32 05',
            expected: {"_packet_type":"faulty_downlink_packet","_raw_payload":"133205","packet_error_reason":"value_error","packet_fport":50},
        });
    });
    ...
    test("local_time_response", () => {
        testPacket({
            ...
            fport: 60,
            data: '03 34546A5F',
            expected: {"_packet_type":"local_time_response","_raw_payload":"0334546A5F","device_local_time__s":1600803892,"device_local_time_formatted":"2020-09-22T19:44:52Z"},
        });
    });
