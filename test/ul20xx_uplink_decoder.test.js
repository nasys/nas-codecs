import { decodeRaw } from '../src/ul20xx_decoder';
      ...
      expected: {
        data: {
          ...
          status_field: {
            ...
            dali_error_connection: { value: false },
            ldr_state: { value: false },
            dig_state: { value: false },
            hardware_error: { value: false },
            firmware_error: { value: false },
            internal_relay_state: { value: false },
          },
          downlink_rssi: { value: -75, unit: 'dBm' },
          downlink_snr: { value: 4, unit: 'dB' },
          mcu_temperature: { value: 21, unit: '°C' },
          analog_interfaces: {
            open_drain_out_state: { value: false },
          ...
          profiles: [{
            ...
            profile_override: { value: 'none', raw: 5 },
            dali_address_short: { value: 'single 5', raw: 10 },
            ...
            profile_override: { value: 'none', raw: 3 },
            dali_address_short: { value: 'single 3', raw: 6 },
            days_active: { value: ['holiday', 'mon', 'tue', 'wed', 'thu', 'fri', 'sat', 'sun'], raw: 255 },
            dimming_level: {
      ...
      expected: {
        data: {
          ...
          profiles: [{
            ...
            profile_version: { value: 'n/a', raw: 250 },
            profile_override: { value: 'ldr_active', raw: 250 },
            dali_address_short: { value: 'broadcast', raw: 254 },
            days_active: { value: ['holiday', 'mon', 'tue', 'wed', 'thu', 'fri', 'sat', 'sun'], raw: 255 },
            dimming_level: {
              value: 0, unit: '%', min: 0, max: 100,
            },
        ...
        errors: ['dali external error reported by status packet'],
        warnings: [],
      },
    });
  });
    ...
    testPacket({
      ...
      expected: {
        data: {
          ...
          reports: [{
            dali_address_short: { value: 'internal_measurement', raw: 255 }, active_energy_total: { value: 1, unit: 'Wh' }, active_energy_instant: { value: 4, unit: 'W' }, lamp_on_time: { value: 0, unit: 'h' },
          }, {
            dali_address_short: { value: 'single 9', raw: 18 }, active_energy_total: { value: 30, unit: 'Wh' }, active_energy_instant: { value: 0, unit: 'W' }, load_side_energy_total: { value: 0, unit: 'Wh' }, load_side_energy_instant: { value: 0, unit: 'W' }, driver_operating_time: { value: 450160, unit: 's' }, lamp_on_time: { value: 17, unit: 's' },
          }],
        },
        errors: [],
        warnings: [],
      ...
      expected: {
        data: {
          ...
          reports: [{
            ...
            dali_address_short: { value: 'invalid', raw: 9 }, active_energy_total: { value: 30, unit: 'Wh' }, active_energy_instant: { value: 0, unit: 'W' }, load_side_energy_total: { value: 0, unit: 'Wh' }, load_side_energy_instant: { value: 0, unit: 'W' }, driver_operating_time: { value: 450160, unit: 's' }, lamp_on_time: { value: 17, unit: 's' },
          }],
        },
        errors: ['invalid_dali_address'],
        warnings: [],
      },
    });
  });
...
describe('Commands', () => {
    ...
    testPacket({
      ...
      expected: {
        data: {
          ...
          dali_statuses: [{
            dali_address_short: { value: 'single 1', raw: 2 }, control_gear_failure: { value: false }, lamp_failure: { value: false }, lamp_on: { value: true }, limit_error: { value: false }, fade_running: { value: false }, reset_state: { value: false }, short_address: { value: false }, power_cycle_seen: { value: false },
          }, {
            dali_address_short: { value: 'single 3', raw: 6 }, control_gear_failure: { value: false }, lamp_failure: { value: true }, lamp_on: { value: false }, limit_error: { value: false }, fade_running: { value: false }, reset_state: { value: false }, short_address: { value: false }, power_cycle_seen: { value: false },
          }, {
            dali_address_short: { value: 'single 6', raw: 12 }, control_gear_failure: { value: false }, lamp_failure: { value: true }, lamp_on: { value: false }, limit_error: { value: false }, fade_running: { value: false }, reset_state: { value: false }, short_address: { value: false }, power_cycle_seen: { value: false },
          }],
        },
        errors: ['Dali address: single 3 errors: lamp failure', 'Dali address: single 6 errors: lamp failure'],
        warnings: [],
      },
    });
  });
  ...
  test('interface_request response from DS', () => {
    testPacket({
      ...
      expected: {
        data: {
          packet_type: { value: 'interface_request' }, dig: { value: 'off', raw: 0 }, ldr: { value: 69, raw: 69 }, main_relay_state: { value: false }, open_drain_out_state: { value: false },
        },
        errors: [],
        warnings: [],
      },
  ...
  test('driver_memory_write response', () => {
    testPacket({
      ...
      expected: {
        data: {
          packet_type: { value: 'driver_memory_write' }, dali_address_short: { value: 'single 2', raw: 4 }, memory_bank: { value: 0 }, memory_address: { value: 3 }, memory_value: { value: '0607EDFACE82E5' },
        },
        errors: [],
        warnings: [],
      },
    ...
    testPacket({
      ...
      expected: {
        data: {
          ...
          drivers: [{
            dali_address_short: { value: 'single 1', raw: 2 }, control_gear_failure: { value: false }, lamp_failure: { value: true }, lamp_on: { value: false }, limit_error: { value: false }, fade_running: { value: false }, reset_state: { value: false }, short_address: { value: false }, power_cycle_seen: { value: false },
          }],
        },
        errors: ['Dali address: single 1 errors: lamp failure'],
        warnings: [],
      },
    });
  });
...
describe('Boot, etc sys packets', () => {
  test('boot_packet from DS', () => {
    testPacket({
      ...
      expected: {
        data: {
          packet_type: { value: 'boot_packet' }, device_serial: { value: '5083000D' }, firmware_version: { value: '1.1.1', raw: 65793 }, device_unix_epoch: { value: '2020-01-16T15:23:31.000Z', raw: 1579188211 }, device_config: { value: 'dali', raw: 0 }, optional_features: { value: ['dig', 'ldr'], raw: 12 }, dali_supply_state: { value: 'bus_high', raw: 126 }, dali_power_source: { value: 'external', raw: true }, dali_addressed_driver_count: { value: 1 }, dali_unadressed_driver_found: { value: false }, reset_reason: { value: ['soft_reset'], raw: 4 },
        },
        errors: [],
        warnings: [],
      },
  ...
  test('boot_packet external', () => {
    testPacket({
      ...
      expected: {
        data: {
          packet_type: { value: 'boot_packet' }, device_serial: { value: '51123456' }, firmware_version: { value: '1.0.22', raw: 65558 }, device_unix_epoch: { value: 'P0000-00-00T00:00:14', raw: 946684814 }, device_config: { value: 'analog_nc', raw: 3 }, optional_features: { value: ['ldr', 'metering'], raw: 104 }, dali_supply_state: { value: 'bus_high', raw: 126 }, dali_power_source: { value: 'internal', raw: false }, dali_addressed_driver_count: { value: 0 }, dali_unadressed_driver_found: { value: false }, reset_reason: { value: [], raw: 0 },
        },
        errors: [],
        warnings: [],
      },
